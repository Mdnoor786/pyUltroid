...
def load_plugins(plugin_name):
    ...
    modules[f"plugins.{plugin_name}"] = mod
...
def load_assistant(plugin_name):
    ...
    mod.asst_cmd = asst_cmd
    spec.loader.exec_module(mod)
    modules[f"assistant.{plugin_name}"] = mod
...
def load_pmbot(plugin_name):
    ...
    name = f"assistant.pmbot.{plugin_name}"
    spec = util.spec_from_file_location(name, path)
    mod = util.module_from_spec(spec)
    mod.ultroid_bot = ultroid_bot
    mod.ultroid = ultroid_bot
    ...
    mod.asst_cmd = asst_cmd
    spec.loader.exec_module(mod)
    modules[f"assistant.pmbot{plugin_name}"] = mod
...
def load_manager(plugin_name):
    ...
    name = f"assistant.manager.{plugin_name}"
    spec = util.spec_from_file_location(name, path)
    mod = util.module_from_spec(spec)
    mod.ultroid_bot = ultroid_bot
    mod.ultroid = ultroid_bot
    ...
    mod.asst_cmd = asst_cmd
    spec.loader.exec_module(mod)
    modules[f"assistant.manager{plugin_name}"] = mod
...
def load_vc(plugin_name):
    ...
    spec.loader.exec_module(mod)
    modules[f"vcbot{plugin_name}"] = mod
